	...
	public class KhaosConfig
	{
		public KhaosConfig()
		{
			...
			Actions = new List<Action>
			{
				...
				new Action{Name="Khaos Equipment", Enabled = true, Meter = 7, AlertPath = Paths.AlucardWhatSound},
				...
				new Action{Name="Pandora's Box", Enabled = true, Meter = 15, AlertPath = Paths.AlucardWhatSound},
				new Action{Name="Gamble", Enabled = true, Meter = 2, AlertPath = Paths.LibrarianThankYouSound},
				new Action{Name="Khaotic Burst", Enabled = true, Meter = 10, AlertPath = Paths.AlucardWhatSound},
				new Action{Name="Bankrupt", Enabled = true, Meter = 12, AlertPath = Paths.DeathLaughSound},
				new Action{Name="Weaken", Enabled = true, Meter = 8, AlertPath = Paths.RichterLaughSound},
				...
				new Action{Name="Cripple", Enabled = true, Meter = 8, Duration = new System.TimeSpan(0, 1, 0), AlertPath = Paths.DeathLaughSound},
				new Action{Name="Blood Mana", Enabled = true, Meter = 4, Duration = new System.TimeSpan(0, 1, 0), AlertPath = Paths.DeathLaughSound},
				...
				new Action{Name="Endurance", Enabled = true, Meter = 7, AlertPath = Paths.DeathLaughSound},
				new Action{Name="HnK", Enabled = true, Meter = 7, AlertPath = Paths.DeathLaughSound, Duration = new System.TimeSpan(0, 1, 0)},
				...
				new Action{Name="Medium Help", Enabled = true, Meter = 5, AlertPath = Paths.FairyPotionSound},
